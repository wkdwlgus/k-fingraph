...
- [→] (선택) Streamlit 워크벤치 selectbox 옵션이 2,659개로 늘어남 — 데스크톱
  브라우저 직접 확인 필요해 sprint 안에서 닫지 못함. `tasks/backlog.md` 잡일
  풀로 이관됨
...
- [x] git tag `v0.5.0` (annotated) + `git push origin v0.5.0` 완료
